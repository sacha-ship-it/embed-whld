...
async function registerCommands() {
  const commands = [
    new SlashCommandBuilder()
      .setName("embed")
      .setDescription("Cree un embed personnalise")
      .addChannelOption(o => o.setName("canal").setDescription("Canal ou envoyer l'embed").setRequired(true))
      ...
      .addStringOption(o => o.setName("footer_icon").setDescription("URL de l'icone du footer").setRequired(false))
      .addStringOption(o => o.setName("author").setDescription("Nom de l'auteur").setRequired(false))
      .addStringOption(o => o.setName("author_icon").setDescription("URL de l'icone de l'auteur").setRequired(false))
  ].map(c => c.toJSON())
...
client.on("interactionCreate", async interaction => {
  ...
  if (interaction.isModalSubmit() && interaction.customId === "embed_modal") {
    ...
    if (!options) {
      return interaction.reply({ content: "Session expiree. Relance /embed.", ephemeral: true })
    }
